    ...
    function $Breadcrumb() {
        ...
        this.$get = ['$state', '$stateParams', '$rootScope', function ($state, $stateParams, $rootScope) {
                ...
                var $$addStateInChain = function (chain, stateRef) {
                    var conf, parentParams, ref = parseStateRef(stateRef), force = false, skip = false;
                ...
                var $$breadcrumbParentState = function (stateRef) {
                    var ref = parseStateRef(stateRef), conf = $state.get(ref.state);
                ...
                return {
                    ...
                    getStatesChain: function (exitOnFirst) {
                        var chain = [];
